...
const UIWelcome = () => (
  ...
  <div className="wrap">
    <div className="row">
      ...
      <div className="columns small-12">
        <p className="u-mb-8">This site aims to provide everything you need to get up to speed quickly when designing for MongoDB. 
        ...
        <p className="u-mb-8">Listed in the navigation under their respective product names (<Link to="/ui-design-system/compass-components">Compass</Link>, Cloud, Stitch, University)</p>
